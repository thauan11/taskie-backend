...
import { getUser, getUserSpecific, updateUser } from '../controllers/userController';
...
router.get('/', getUser);
router.get('/:userId', validateUserId, getUserSpecific);
router.patch('/:userId', validateUser, updateUser);
router.patch('/:userId/portrait', validateUserId, updateUser);
...
router.delete('/:userId/collections/:collectionId', validateUserId, deleteCollection);
